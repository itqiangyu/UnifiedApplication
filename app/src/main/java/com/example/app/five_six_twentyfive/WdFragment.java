...
public class WdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View tool = inflater.inflate(R.layout.wd_fragment, container, false);

        LineChart mChart2 = tool.findViewById(R.id.chart);


        dynamicLineChart = new WdFragment.DynamicLineChart(mChart2);
        //循环添加数据
    ...
    private WdFragment.DynamicLineChart dynamicLineChart;
