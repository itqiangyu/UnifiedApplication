...
public class GzFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View tool = inflater.inflate(R.layout.gz_fragment, container, false);

        LineChart mChart2 = tool.findViewById(R.id.chart);

        dynamicLineChart = new GzFragment.DynamicLineChart(mChart2);
        //循环添加数据
    ...
    private GzFragment.DynamicLineChart dynamicLineChart;
