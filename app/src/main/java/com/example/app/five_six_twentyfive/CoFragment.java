...
public class CoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View tool = inflater.inflate(R.layout.co_fragment, container, false);

        LineChart mChart2 = tool.findViewById(R.id.chart);

        dynamicLineChart = new CoFragment.DynamicLineChart(mChart2);
        //循环添加数据
    ...
    private CoFragment.DynamicLineChart dynamicLineChart;
