...
public class PmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View tool = inflater.inflate(R.layout.pm_fragment, container, false);

        LineChart mChart2 = tool.findViewById(R.id.chart);

        dynamicLineChart = new PmFragment.DynamicLineChart(mChart2);
        //循环添加数据
    ...
    private PmFragment.DynamicLineChart dynamicLineChart;
