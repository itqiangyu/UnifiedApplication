...
public class SdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View tool = inflater.inflate(R.layout.sd_fragment, container, false);

        LineChart mChart2 = tool.findViewById(R.id.chart);

        dynamicLineChart = new SdFragment.DynamicLineChart(mChart2);
        //循环添加数据
    ...
    private SdFragment.DynamicLineChart dynamicLineChart;
